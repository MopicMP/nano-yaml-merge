...
> Nano merge yaml config files

[![PyPI version](https://badge.fury.io/py/nano-yaml-merge.svg)](https://pypi.org/project/nano-yaml-merge/)
...
```bash
pip install nano-yaml-merge
```

## Quick Start

```python
from nano_yaml_merge import merge

# Basic usage
result = merge("your input here")
print(result)
```
...
result = merge("Hello World")

# Example 2: Batch processing
from nano_yaml_merge import batch
